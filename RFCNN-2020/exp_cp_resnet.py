...
def main():
    ...
    parser.add_argument('--dataset', default="dcase2019.json", type=str,
    ...
    default_conf['out_dir'] = default_conf['out_dir'].replace("cp_resnet",args.arch) + str(datetime.now().strftime('%b%d_%H.%M.%S'))
